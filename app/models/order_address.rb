class OrderAddress
  ...
  attr_accessor :user_id, :item_id, :postal_cade, :prefectures_id, :city, :house_number, :building_name, :telephone_number, :token
  ...
  with_options presence: true do
    ...
    validates :telephone_number, format: { with: /\A\d{10,11}\z/, message: 'is invalid. Input only half-width number' },
  ...
  def save
    ...
    Address.create(postal_cade: postal_cade, prefectures_id: prefectures_id, city: city, house_number: house_number,
